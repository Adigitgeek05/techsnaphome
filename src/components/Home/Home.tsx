...
return (
  ...
  <div className="flex flex-col mt-4 items-center">
    ...
    <div className="bg-black text-white flex flex-col items-center justify-center p-10 w-[95%] max-w-[1200px] xl:max-w-[1300px] 2xl:max-w-[1400px] 3xl:max-w-[1500px] h-[95vh] border-4 border-t-0 rounded-b-lg rounded-t-4xl relative m-auto">
      <></>
